...
for x in range(0,len(dataArray)):
    ...
    #down/up
    if x < 340:
        if dataArray[x] * dataArray[x+20] * dataArray[x+40] * dataArray[x+60] > highestProduct:
            highestProduct = dataArray[x] * dataArray[x+20] * dataArray[x+40] * dataArray[x+60]
    else:
        if dataArray[x] * dataArray[x-20] * dataArray[x-40] * dataArray[x-60] > highestProduct:
            highestProduct = dataArray[x] * dataArray[x-20] * dataArray[x-40] * dataArray[x-60]
    ...
    if x % 20 < 17:
        ...
        if dataArray[x] * dataArray[x+1] * dataArray[x+2] * dataArray[x+3] > highestProduct:
            highestProduct = dataArray[x] * dataArray[x+1] * dataArray[x+2] * dataArray[x+3]
    else:
        if dataArray[x] * dataArray[x-1] * dataArray[x-2] * dataArray[x-3] > highestProduct:
            highestProduct = dataArray[x] * dataArray[x-1] * dataArray[x-2] * dataArray[x-3]
     ...
     #diagonal
    if x % 20 < 17 and x < 340 and x % 20 > 2:
            if dataArray[x] * dataArray[x+21] * dataArray[x+42] * dataArray[x+63] > highestProduct:
                highestProduct = dataArray[x] * dataArray[x+21] * dataArray[x+42] * dataArray[x+63]
            if dataArray[x] * dataArray[x+19] * dataArray[x+38] * dataArray[x+57] > highestProduct:
                highestProduct = dataArray[x] *  dataArray[x+19] * dataArray[x+38] * dataArray[x+57]
            if dataArray[x] * dataArray[x - 21] * dataArray[x-38] * dataArray[x-57] > highestProduct:
                highestProduct = dataArray[x] *  dataArray[x-21] * dataArray[x-38] * dataArray[x-57]
            if dataArray[x] * dataArray[x-21] * dataArray[x-42] * dataArray[x-63] > highestProduct:
                highestProduct = dataArray[x] *  dataArray[x-21] * dataArray[x-42] * dataArray[x-63]
            
    #else:
     #       if dataArray[x] * dataArray[x-21] * dataArray[x-42] * dataArray[x-63] > highestProduct:
      #          highestProduct = dataArray[x-21] * dataArray[x-42] * dataArray[x-63]
